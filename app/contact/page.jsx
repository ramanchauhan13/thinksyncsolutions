    ...
    <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-blue-600 selection:text-white overflow-x-hidden">
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-6 py-26">
        <div className="grid lg:grid-cols-2 gap-24 items-start">
          ...
          <div className="sticky">
            <div className="flex items-center gap-4 mb-8">
              ...
              <span className="text-blue-600 font-black uppercase tracking-[0.4em] text-[10px]">Project Inquiry</span>
            </div>
            ...
            <p className="text-2xl font-bold text-slate-400 leading-tight mb-10 max-w-md italic">
              "We transform technical debt into digital equity. Tell us what you're building."
            </p>
            
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-10 border-t border-slate-100 pt-6">
              <div>
                <p className="text-slate-400 font-black uppercase tracking-widest text-[10px] mb-4">Direct Email</p>
                <a href="mailto:hello@thinksync.solutions" className="text-xl font-black hover:text-blue-600 transition-colors">hello@thinksync.dev</a>
              </div>
              <div>
                <p className="text-slate-400 font-black uppercase tracking-widest text-[10px] mb-4">Urgent Call</p>
                <a href="tel:+12345678" className="text-xl font-black hover:text-blue-600 transition-colors">+1 555 000 000</a>
              </div>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="bg-white p-8 md:p-10 rounded-[3.5rem] border border-slate-100 shadow-[0_32px_64px_-16px_rgba(0,0,0,0.05)]">
              <form className="space-y-8">
                ...
                <div>
                  <label className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-6 block">What are we building?</label>
                  <div className="flex flex-wrap gap-3">
                    {['Development', 'UI/UX Design', 'Automation'].map((type) => (
                      <button
                        key={type}
                        type="button"
        ...
        <div className="mt-14 border-t border-slate-100 flex flex-wrap justify-between items-center gap-12 grayscale opacity-30">
          <span className="font-black text-2xl tracking-tighter">THINKSYNC SOLUTIONS.</span>
          <span className="font-black text-2xl tracking-tighter italic text-blue-600">READY TO BUILD.</span>
