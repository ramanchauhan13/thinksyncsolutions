      ...
      <main className="relative z-10 max-w-full mx-auto px-6 py-20">
        ...
        <div className="space-y-12 mb-24">
          {projects.map((project, idx) => {
            ...
            // Determine light vs. dark theme for this card
            const isLight = project.color?.includes("bg-slate-100");
            ...
            return (
              ...
              >
                ...
                {/* Right Visual Card Column (Clear & Vibrant Preview) */}
                <div
                ...
                >
                  {/* Clean Background Screenshot */}
                  <div className="absolute inset-0 z-0">
                    <img
                      src={imageUrl}
                      alt={`${project.title} Preview`}
                      className="w-full h-full object-cover object-top opacity-85 group-hover/card:scale-105 group-hover/card:opacity-100 transition-all duration-500"
                      loading="lazy"
                    />
                    {/* Minimal subtle gradient at bottom for text visibility */}
                    <div
                  ...
                  <div className="flex justify-end items-start relative z-10">
                    {/* <div className="p-2.5 rounded-xl bg-slate-950/80 border border-slate-700 text-blue-400 shadow-lg">
                      <FolderGit2 size={22} />
                    </div> */}
                    <Link
                      href={project.slug ? `/work/${project.slug}` : project.link || "#"}
                      className="w-11 h-11 rounded-full bg-blue-600 hover:bg-slate-900 text-white flex items-center justify-center transition-all shadow-xl hover:scale-105"
                    >
                      <ArrowUpRight size={20} />
                    </Link>
                  </div>

                  {/* Live Deployment Specs Box */}
                  <div
...
//                 <div
//                   className={`lg:col-span-5 z-10 flex flex-col justify-between h-full ${
//                     isLight
//                       ? "bg-white/80 border-slate-200"
//                       : "bg-slate-950/60 border-slate-800/60 "
//                   } rounded-[2rem] p-6 border min-h-[220px] group-hover:scale-[1.02] transition-transform duration-500`}
//                 >
//                   <div className="flex justify-between items-start">
//                     <FolderGit2 className="text-blue-600" size={32} />
//                     <Link
//                       href={project.slug ? `/work/${project.slug}` : project.link || "#"}
//                       className="w-12 h-12 rounded-full bg-blue-600 hover:bg-slate-900 text-white flex items-center justify-center transition-all shadow-lg shadow-blue-600/30"
//                     >
...
//                       isLight ? "text-slate-600 bg-slate-50 border-slate-200" : "text-slate-400 bg-slate-900/80 border-slate-800"
...
//                       } text-[10px] uppercase tracking-widest border-b pb-2`}
//                     >
//                       <Sparkles size={12} className="text-blue-600" /> Live Deployment
//                     </div>
//                     <div className="flex justify-between">
//                       <span>Status:</span>
//                       <span className={isLight ? "text-emerald-600 font-bold" : "text-emerald-400 font-bold"}>
...
//                     <div className="flex justify-between">
//                       <span>Architecture:</span>
//                       <span className="text-blue-600 font-bold">Modular</span>
//                     </div>
//                   </div>
//                 </div>
