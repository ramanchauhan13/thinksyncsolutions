...
const Testimonials = () => {
  ...
  const reviews = [
  {
    quote: "Working with ThinkSync Solutions was super easy. They listened to what I needed and turned my ideas into a really smooth, modern website. It honestly made my job a lot easier.",
    client: "Ayush Gaur",
    position: "Event Manager",
    metric: "Smooth Project Delivery"
  },
  {
    quote: "I wanted a site that looked clean and loaded fast, and that’s exactly what they delivered. The team kept me updated the whole time and finished earlier than I expected.",
    client: "Lalit Singh Mehta",
    position: "Architect",
    metric: "Fast & Optimized Website"
  },
  {
    quote: "I’m not very tech-savvy, but these guys explained everything simply and built a site my students love using. It feels smooth and professional without being complicated.",
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-4">
          <div className="max-w-xl">
            <div className="flex items-center gap-4 mb-4">
              ...
              <span className="text-blue-600 font-black uppercase tracking-[0.4em] text-[10px]">Proof of Performance</span>
            </div>
          ...
          <div className="flex gap-4 mt-8 md:mt-0">
            <button onClick={prev} className="p-6 border border-slate-100 rounded-full hover:bg-blue-600 hover:text-white transition-all group">
              <ChevronLeft size={24} />
            </button>
            <button onClick={next} className="p-6 bg-blue-600 text-white rounded-full hover:bg-slate-900 transition-all shadow-xl shadow-blue-200">
          ...
          {reviews.map((r, i) => (
            <div 
              ...
              className={`absolute inset-0 transition-all duration-700 ease-in-out flex flex-col md:grid md:grid-cols-12 items-center gap-12 ${
                i === active ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-20 pointer-events-none'
              }`}
            >
              {/* Quote Content */}
              <div className="md:col-span-8">
                ...
                <div>
                  <h4 className="text-xl font-black uppercase tracking-tighter">{r.client}</h4>
                  <p className="text-blue-600 font-black uppercase tracking-widest text-[10px]">{r.position}</p>
                </div>
              </div>
              ...
              <div className="md:col-span-5 lg:col-span-4 w-full h-full flex items-center">
                <div className="w-full bg-slate-950 p-8 rounded-[2.5rem] text-white relative overflow-hidden group border border-white/5 shadow-2xl">
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-[10px] font-black uppercase tracking-[0.4em] text-blue-400 mb-2">Success Metric</p>
                    ...
                    <div className="mt-6 flex gap-1">
                       {[...Array(4)].map((_, i) => (
                         <div key={i} className="h-1 w-6 bg-white/10 rounded-full overflow-hidden">
           ...
           {reviews.map((_, i) => (
             <button
               ...
               className={`h-1.5 transition-all duration-500 rounded-full ${
                 i === active ? 'w-24 bg-blue-600' : 'w-8 bg-slate-100 hover:bg-slate-200'
               }`}
             />
           ))}
        </div>
