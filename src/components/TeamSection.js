            ...
            return (
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="w-20 h-20 rounded-xl overflow-hidden mb-6 group-hover:rotate-12 transition-transform duration-500 relative">
                    <Image
                      src={member.image}
                      alt={member.name || "Member"}
                      fill
                      sizes="64px" // This matches w-16 (16 * 4px = 64px)
                  ...
                  <p
                    className={`text-lg font-semibold bg-gradient-to-r ${member.color} bg-clip-text text-transparent mb-2`}
                  >
                    {member.role}
                  </p>
